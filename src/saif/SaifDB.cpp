...
std::ostream &saif::SaifSignal::streamout(std::ostream &os,
...
std::ostream &saif::SaifInstance::streamout(std::ostream &os,
...
std::ostream &saif::SaifDB::streamout(std::ostream &os) const {
  ...
  os << "(TIMESCALE " << timescale.first.get_str() << " " << timescale.second
     << ")" << std::endl;
